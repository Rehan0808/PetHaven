  ...
  return (
    <div className="bg-gray-900 text-white">
      ...
      <div
        ...
        style={{
          backgroundImage: `url("/home.jpg")`, // <-- This references puppy.jpeg from public folder
        }}
      >
        ...
        <div className="relative z-10 px-4 text-center max-w-3xl">
          ...
          <button className="bg-red-500 hover:bg-red-600 text-white font-bold px-6 py-3 rounded">
            Adopt Now
          </button>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center">
            <img
              src="/image.png" // Replace with your own about-section image
          ...
          {/* RIGHT COLUMN: Text */}
          <div>
            <h3 className="text-red-500 text-lg font-semibold uppercase mb-2">
              About Us
            </h3>
            ...
            <button className="bg-red-500 hover:bg-red-600 text-white font-bold px-5 py-2 rounded">
              Get More Info
            </button>
          </div>
        </div>
