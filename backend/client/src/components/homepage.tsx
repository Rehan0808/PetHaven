  ...
  return (
    <div className="bg-[#F7F9FA] text-[#333333]">
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#2C3E50] bg-opacity-40"></div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          {/* RIGHT COLUMN: Text */}
          <div>
            <h3 className="text-[#2980B9] text-lg font-semibold uppercase mb-2">
              About Us
            </h3>
            ...
            <button className="bg-[#E67E22] hover:bg-[#cf6e1d] text-white font-bold px-5 py-2 rounded">
              Get More Info
            </button>
          </div>
        </div>
