...
import { LoginUser } from "../../types"; // <-- Import LoginUser here
...
export const LoginFrom = () => {
  ...
  const handleLogin = (e: React.MouseEvent<HTMLFormElement>) => {
    ...
    // Use the LoginUser type for userData
            ...
            <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
              <form onSubmit={handleLogin}>
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  >
                    New to petHeaven? Register for an account!
                  </Link>
                </div>
                ...
                <button
                  ...
                  className="inline-block focus:outline-none focus:ring-2 focus:ring-offset-2
                    focus:ring-gray-800 text-base flex rounded-lg items-center justify-center leading-none
                    text-white bg-slate-700 w-full py-4 hover:bg-gray-900"
